...
<div class="form-popup" id="myForm1" style="top:50px; height:1000px;">

	<table style='background-color:white; width:60%; text-align:center; font-size:25px; border-radius:50px;background: linear-gradient(to bottom, #ccffff 0%, #ffff99 100%);' id='fname' cellpadding="18px" align='center'>
		<tr><td colspan=2><span style="font-family: 'Akaya Kanadaka';font-size: 35px;text-align: center; top:45px;">Contacts</span></td></tr>
		<tr>
			<th>Name</th>
